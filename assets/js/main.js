/*
  ...
  01 Documentation
      - Stereo Wall
  02 Product
  03 Portrait / Commercial

  To add projects later, edit only CATEGORIES.
*/
...
const CATEGORIES = [
  {
    ...
    number: "01",
    title: "DOCUMENTATION",
    description: "Event, stage, and visual documentation.",
    previewImages: [
...

  {
    ...
    description: "Portrait, fashion, and commercial visual work.",
    previewImages: [],
    projects: []
  }
];
...
function createCategoryCards() {
  ...
  CATEGORIES.forEach((category) => {
    ...
    imageOne.alt = images[0] ? `${category.title} preview` : "";
    imageOne.loading = "lazy";

    const imageTwo = document.createElement("img");
    imageTwo.className = "category-image next";
    imageTwo.src = images[1] || images[0] || "";
    imageTwo.alt = "";
